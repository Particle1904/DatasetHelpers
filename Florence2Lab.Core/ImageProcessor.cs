...
public class ImageProcessor
{
    ...
    /// <summary>
    /// Asynchronously processes the input image by resizing and normalizing it into a tensor format.
    /// </summary>
    ...
    /// <returns>
    /// A task representing the asynchronous operation. The result is a <see cref="DenseTensor{T}"/> containing the normalized image data
    ...
    /// <summary>
    /// Asynchronously resizes the given image to a fixed square size of 768x768 pixels.
    /// </summary>
    ...
    /// <summary>
    /// Asynchronously creates a normalized tensor from the given image.
    /// </summary>
    /// <param name="image">The RGB image to convert to a tensor. The image must be 768x768 pixels.</param>
    /// <returns>
    /// A task representing the asynchronous operation. The result is a <see cref="DenseTensor{T}"/> 
